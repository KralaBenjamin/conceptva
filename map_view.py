...
class DataclassProperties:
    ...
    cols_to_title = {
        'sensor_1': 'Salinity in PSU',
        'QF_sensor_1': 'Quality Flag',
        'sensor_2': 'Temperature in Celsius',
        'QF_sensor_2': 'Quality Flag',
        'sensor_3': 'CDOM in arb. units',
        'QF_sensor_3': 'Quality Flag',
        'sensor_4': 'Chlorophyll in ug/l',
        'QF_sensor_4': 'Quality Flag',
        'sensor_5': 'DO in umol/l',
        'QF_sensor_5': 'Quality Flag',
        'sensor_6': 'DOSat in percent',
        'QF_sensor_6': 'Quality Flag',
        'sensor_7': 'DO_Anomaly in umol',
        'QF_sensor_7':'Quality Flag'
    }
...
class map_view(QtWidgets.QMainWindow):
    ...
    def create_gui(self):
        ...
        self.radarplot_webview.setFixedWidth(600)
    ...
    def show_new_plot(self):
        ...
        create_diagram2(diagram_average_below_salicity,
                       ...
                       used_db_to_max,
                       used_db_to_min,
                       DataclassProperties.cols_to_title)
